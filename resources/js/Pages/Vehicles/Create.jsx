    ...
    useEffect(() => {
        if (data.marke) {
            ...
            axios.get(`/api/v1/cars/models/${data.marke}`)
                .then(response => {
                    console.log("API grąžino modelius:", response.data[0]); // Pažiūrėkite pirmą elementą
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                {filteredMakes.length > 0 && (
                                    <div className="search-results mt-1 absolute z-10 bg-white border border-gray-300 rounded shadow-lg w-full max-w-2xl">
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="vin_kodas">
                                    VIN kodas (įvedus 17 simbolių, bandys automatiškai užpildyti laukus)
                                </label>
                                <input
                                    type="text"
                                    id="vin_kodas"
